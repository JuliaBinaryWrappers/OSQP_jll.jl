# Autogenerated wrapper script for OSQP_jll for x86_64-apple-darwin14
export qdldl, osqp
...
const qdldl_splitpath = ["lib", "libqdldl.dylib"]
...
const qdldl = "@rpath/libqdldl.dylib"


# Relative path to `osqp`
const osqp_splitpath = ["lib", "libosqp.dylib"]
...
# This must be `const` so that we can use it with `ccall()`
const osqp = "@rpath/libosqp.dylib"
