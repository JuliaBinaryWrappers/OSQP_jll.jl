...
if VERSION < v"1.3.0-rc4"
    ...
    error("Unable to import OSQP_jll on Julia versions older than 1.3!")
end
...
artifacts = Pkg.Artifacts.load_artifacts_toml(artifacts_toml; pkg_uuid=UUID("9c4f68bf-6205-5545-a508-2878b064d984"))
platforms = [Pkg.Artifacts.unpack_platform(e, "OSQP", artifacts_toml) for e in artifacts["OSQP"]]
...
if best_platform === nothing
    @debug("Unable to load OSQP; unsupported platform $(triplet(platform_key_abi()))")
else
